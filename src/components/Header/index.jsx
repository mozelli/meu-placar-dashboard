...
const Header = () => {
  const {setLogged, setId, name, setName, lastName, setLastName, setEmail, setToken} = useContext(UserContext);
    ...
    <nav className="navbar navbar-expand-lg shadow-sm mb-4">
      <div className="container-fluid">
        ...
        <div className="d-flex">
          ...
          <button className="btn btn-danger ms-2 d-flex align-items-center" onClick={() => logOut()}>
